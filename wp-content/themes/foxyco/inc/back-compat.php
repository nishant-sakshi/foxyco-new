 ...
 * @since Twenty Seventeen 1.0
 */
function foxyco_switch_theme() {
	switch_theme( WP_DEFAULT_THEME );
	unset( $_GET['activated'] );
	add_action( 'admin_notices', 'foxyco_upgrade_notice' );
}
add_action( 'after_switch_theme', 'foxyco_switch_theme' );
 ...
 */
function foxyco_upgrade_notice() {
...
add_action( 'load-customize.php', 'foxyco_customize' );
...
add_action( 'template_redirect', 'foxyco_preview' );
